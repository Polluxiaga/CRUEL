"""Compute quick trajectory-speed statistics for scenario-labeled folders."""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Plot speed and trajectory statistics by folder-name scenario tag.")
    parser.add_argument("--root", default=ROOT_FOLDER, help="Root folder containing trajectory subfolders.")
    args = parser.parse_args()

    print(f"开始分析文件夹: {args.root}")
    categories = process_folder(args.root)
